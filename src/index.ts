...
server.registerTool(
  "download_mod",
  {
    ...
    inputSchema: {
      ...
      destDir: z.string().optional().describe(
        "Directory to save the file. Defaults to DOWNLOAD_DIR env var or current directory.",
      ),
    },
  },
...
console.error(
  `nexus-mcp ready (auth: ${hasApiKey ? "personal API key" : "anonymous — set NEXUS_MODS_API_KEY for viewer data and downloads"})`,
);
